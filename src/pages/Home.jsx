    ...
    <div className=' lg:overflow-hidden bg-white'>
      <div className=' md:py-20 py-5  grid grid-cols-1 md:grid-cols-2   justify-center items-center gap-3'>
        <div className='flex flex-col justify-center items-center gap-8 text-center'>
          ...
          {/* recipie,about button */}

          <div className='flex gap-4 lg:pt-15 pt-5'>
            <button className='bg-black rounded-lg text-white p-2  cursor-pointer  hover:scale-105' onClick={() => navigate("/recipies")}>Explore recepies</button>
